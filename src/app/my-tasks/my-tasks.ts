        ...
        <div class="row-layout group_3">
          <div class="column-layout group_4">
            ...
            <igc-list class="list_1">
              <igc-list-item>
                <div slot="start">
                  <igc-avatar src="https://d3cg6cexo8t5ug.cloudfront.net/avatars/avatar1.png" shape="circle" class="avatar"></igc-avatar>
                </div>
              ...
              <igc-list-item>
                <div slot="start">
                  <igc-avatar src="https://d3cg6cexo8t5ug.cloudfront.net/avatars/avatar2.png" shape="circle" class="avatar"></igc-avatar>
                </div>
            ...
            <igc-list class="list_1">
              <igc-list-item>
                <div slot="start">
                  <igc-avatar src="https://d3cg6cexo8t5ug.cloudfront.net/avatars/avatar3.png" shape="circle" class="avatar"></igc-avatar>
                </div>
              ...
              <igc-list-item>
                <div slot="start">
                  <igc-avatar src="https://d3cg6cexo8t5ug.cloudfront.net/avatars/avatar5.png" shape="circle" class="avatar"></igc-avatar>
                </div>
              ...
              <igc-list-item>
                <div slot="start">
                  <igc-avatar src="https://d3cg6cexo8t5ug.cloudfront.net/avatars/avatar6.png" shape="circle" class="avatar"></igc-avatar>
                </div>
              ...
              <igc-list-item>
                <div slot="start">
                  <igc-avatar src="https://d3cg6cexo8t5ug.cloudfront.net/avatars/avatar4.png" shape="circle" class="avatar"></igc-avatar>
                </div>
